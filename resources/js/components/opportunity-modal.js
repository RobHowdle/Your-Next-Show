...
export function initOpportunityModal({ dashboardType }) {
    ...
    function getFormData() {
        ...
        const selectedGenres = $('#eventForm input[name="genres[]"]:checked')
            .map(function () {
                return $(this).val();
            })
            .get();
                ...
                if (type === "artist_wanted") {
                    ...
                    if (eventData) {
                        ...
                        if (excludedIds.length > 0) {
                            ...
                            $("#excluded_entities").val(excludedIds.join(","));
                        }
                    }
                }
            },
    ...
    function initializeArtistTimePickers() {
        ...
        const endPicker = flatpickr("#performance_end_time", timePickerOptions);
    ...
    function calculateSetLength() {
        ...
        const endTimeInput = document.querySelector("#performance_end_time");
